...
if (logOutBtn) logOutBtn.forEach((el)=>{
    el.addEventListener("click", (0, _login.logout));
});
// ADMIN
// Create
if (createCategoryForm) createCategoryForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    ...
    (0, _admin.createCategory)(form);
});
if (createProductForm) createProductForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const form = new FormData();
    const categorySelectBox = document.querySelector(".create-product-category");
    const categoryOption = categorySelectBox.options[categorySelectBox.selectedIndex];
    const category = categoryOption.value;
    form.append("category", category);
    form.append("name", document.querySelector(".create-product-name").value);
    form.append("smallDescription", document.querySelector(".create-product-small-description").value);
    form.append("description", document.querySelector(".create-product-description").value);
    form.append("originalPrice", document.querySelector(".create-product-original-price").value);
    form.append("sellingPrice", document.querySelector(".create-product-selling-price").value);
    form.append("image", document.querySelector(".create-product-image").files[0]);
    form.append("quantity", document.querySelector(".create-product-quantity").value);
    form.append("status", document.querySelector(".create-product-status").checked);
    form.append("trending", document.querySelector(".create-product-trending").checked);
    (0, _admin.createProduct)(form);
});
// Delete
if (deleteProductBtn) deleteProductBtn.forEach((el)=>el.addEventListener("click", ()=>{
        const prodID = el.value;
        (0, _admin.deleteOne)(prodID, "product");
    }));
if (deleteCategoryBtn) deleteCategoryBtn.forEach((el)=>el.addEventListener("click", ()=>{
        const categoryID = el.value;
        (0, _admin.deleteOne)(categoryID, "category");
    }));
// Edit
if (editCategoryForm) editCategoryForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const form = new FormData();
    form.append("name", document.querySelector(".edit-category-name").value);
    form.append("status", document.querySelector(".edit-category-status").checked);
    if (!document.querySelector(".edit-category-image").files[0]) form.append("image", document.querySelector(".edit-category-old-image").value);
    else form.append("image", document.querySelector(".edit-category-image").files[0]);
    const id = document.querySelector(".edit-category-id").value;
    (0, _admin.editCategory)(form, id);
});
if (editProductForm) editProductForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const form = new FormData();
    ...
    form.append("smallDescription", document.querySelector(".edit-product-small-description").value);
    form.append("description", document.querySelector(".edit-product-description").value);
    form.append("originalPrice", document.querySelector(".edit-product-original-price").value);
    form.append("sellingPrice", document.querySelector(".edit-product-selling-price").value);
    form.append("quantity", document.querySelector(".edit-product-quantity").value);
    form.append("status", document.querySelector(".edit-product-status").checked);
    form.append("trending", document.querySelector(".edit-product-trending").checked);
    if (!document.querySelector(".edit-product-image").files[0]) form.append("image", document.querySelector(".edit-product-old-image").value);
    else form.append("image", document.querySelector(".edit-product-image").files[0]);
    const id = document.querySelector(".edit-product-id").value;
    (0, _admin.editProduct)(form, id);
});
if (quantityIncrementBtn && quantityDecrementBtn && addToCartBtn) {
    ...
    addToCartBtn.addEventListener("click", (e)=>{
        ...
        (0, _stripe.orderProduct)(productId, qty);
    });
}

},{"./login":"7yHem","./register":"eBq2z","./stripe":"10tSC","./admin":"iGA57"}],"7yHem":[function(require,module,exports) {
    ...
    try {
        ...
        if (res.data.status === "success") {
            if (res.data.data.user.role === "admin") {
                (0, _alerts.showAlert)("success", "Redirecting to the admin page");
                window.setTimeout(()=>{
...
const logout = async ()=>{
    try {
        ...
        (0, _alerts.showAlert)("error", "Unable to sign out at this time. Try again later");
    }
};
...
parcelHelpers.export(exports, "showAlertAdmin", ()=>showAlertAdmin);
const hideAlert = ()=>{
...
const showAlertAdmin = (type, msg)=>{
    hideAlert();
    const markup = `<div class="alert alert--${type}">${msg}</div>`;
    document.getElementById("adminBody").insertAdjacentHTML("afterbegin", markup);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eBq2z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "orderProduct", ()=>orderProduct);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const orderProduct = async (prodId)=>{
    try {
        ...
        const session = await (0, _axiosDefault.default)(`/api/v1/orders/checkout-session/${prodId}`);
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iGA57":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteOne", ()=>deleteOne);
parcelHelpers.export(exports, "createCategory", ()=>createCategory);
parcelHelpers.export(exports, "createProduct", ()=>createProduct);
parcelHelpers.export(exports, "editCategory", ()=>editCategory);
...
const deleteOne = async (ID, subject)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "DELETE",
            url: `/api/v1/${subject === "category" ? "categories" : "products"}/${ID}`
        });
        if (res.status === 204) {
            (0, _alerts.showAlertAdmin)("success", `Successfully deleted ${subject}!`);
            window.setTimeout(()=>{
                location.reload(true);
            }, 1000);
        }
    } catch (err) {
        (0, _alerts.showAlertAdmin)("error", err.response.data.message);
    }
};
const createCategory = async (data)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlertAdmin)("success", "Created category!");
            window.setTimeout(()=>{
                location.assign("/allCategories");
            }, 1000);
        }
...
const createProduct = async (data)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlertAdmin)("success", "Successfully created product!");
            window.setTimeout(()=>{
...
const editCategory = async (data, id)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlertAdmin)("success", "Successfully edited category!");
            window.setTimeout(()=>{
                location.assign("/allCategories");
            }, 1000);
        }
...
const editProduct = async (data, id)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlertAdmin)("success", "Successfully edited product!");
            window.setTimeout(()=>{
                location.assign("/allProducts");
            }, 1000);
        }
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dafvh","f2QDv"], "f2QDv", "parcelRequiredca8")
